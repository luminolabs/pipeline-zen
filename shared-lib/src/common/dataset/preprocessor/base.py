...
class BaseDatasetPreprocessor(BaseDataset, ABC):
    ...
    def __init__(self,
        ...
        """
        self._validate_init(dataset, transforms_input_func, transforms_label_func)

        self.dataset = dataset
        self.transforms_input = getattr(self._get_transforms_module(), transforms_input_func)
        self.transforms_label = \
            getattr(self._get_transforms_module(), transforms_label_func) \
    ...
    @staticmethod
    def _validate_init(dataset: SingleLabelDataset,
                       transforms_input_func: str, transforms_label_func: Optional[str] = None):
        """
